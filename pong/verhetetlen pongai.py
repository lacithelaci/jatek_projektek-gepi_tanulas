...
while not vege:
   ...
   # ablak.blit(hatter,(0,0))
    #hattér betöltés
    pygame.draw.rect(ablak, kek, (x, 560, 200, 30))
    pygame.draw.rect(ablak,zold,(laci,0, 200, 30))
    ...
    jatekos2_gyozelem = basic_font.render(f"A győztes a gép! {jatekos2_pont}:{jatekos1_pont} arányra", False,(feher))
    basic_font = pygame.font.Font('freesansbold.ttf', 32)
    ...
    ablak.blit(jatekos_szoveg, (750, 560))

    jatekos2_szoveg = basic_font.render(f'{jatekos2_pont}', False, szurke)
    ablak.blit(jatekos2_szoveg, (750, 20))
    # pontok megjelenése
    if jatekos1_pont==7:
    ...
    if jatekos2_pont==7:
        print(f"A győztes a gép! {jatekos2_pont}:{jatekos1_pont} arányra")
