...
def lvl2() -> None:
    ...
    platforms: list[pygame.Rect] = [
        pygame.Rect(0, 550, 150, 50), pygame.Rect(300, 550, 150, 50), pygame.Rect(600, 550, 200, 50),
    ...
    fireballs: list[FireBall] = [
        FireBall(25, 25, (225, 450), 80, 0.075, math.radians(0)),
    ...
    bombs: list[Bombs] = [
        Bombs(250, 0, 30, 30), Bombs(500, 0, 30, 30)
    ]
